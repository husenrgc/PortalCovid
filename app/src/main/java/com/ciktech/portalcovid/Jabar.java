...
public class Jabar extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, final AppWidgetManager appWidgetManager,
        ...
        final RemoteViews viewss = new RemoteViews(context.getPackageName(), R.layout.activity_jabar);
        ...
        call2.enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                try {
                    ...
                    viewss.setTextViewText(R.id.positif3,rov.get(1).get("kp"));
                    viewss.setTextViewText(R.id.sembuh3, rov.get(1).get("ks"));
                    viewss.setTextViewText(R.id.meninggal3, rov.get(1).get("km"));
                    Log.e("s", "prov bro "+ rov.get(1).get("km"));
